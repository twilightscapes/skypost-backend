...
function updateProButton(isPro) {
  ...
  if (isPro) {
    ...
    btn.setAttribute('style', 'background: linear-gradient(135deg, #00a8e8 0%, #05abedff 100%) !important; color: white !important; padding: 12px 28px !important; font-size: 14px !important; font-weight: 600 !important; border: none !important; border-radius: 4px !important; cursor: pointer !important; white-space: nowrap !important; min-width: 100px !important;');
  }
}
