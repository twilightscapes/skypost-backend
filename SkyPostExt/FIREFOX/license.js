...
class LicenseManager {
  ...
  getFeatureList() {
    return {
      free: [
        { name: 'Compose Posts', limit: 'Unlimited' },
        { name: 'Bluesky Login', limit: 'Yes' },
        { name: 'Link Previews', limit: 'Auto-detect' },
        { name: 'Image Uploads', limit: 'Up to 4' },
        { name: 'Schedule Posts', limit: '1 post' },
        { name: 'Draft Management', limit: 'Yes' },
        { name: 'Backup & Restore', limit: 'Yes' }
      ],
      pro: [
        { name: 'Unlimited Scheduled Posts' },
        { name: 'Custom Link Cards' },
        { name: 'Custom Video Cards' },
        { name: 'Storage Dashboard' },
        { name: 'AdBlock Included' }
      ]
    };
  }
