...
window.renderProModal = async function() {
    ...
    html += `
      <div style="background: linear-gradient(135deg, #00a8e8 0%, #764ba2 100%); color: white; border-radius: 8px; padding: 24px; text-align: center; margin-bottom: 24px;">
        ...
        <div style="font-size: 13px; margin: 15px 0; line-height: 1.6;">
          ✓ Schedule unlimited posts<br>
          ✓ Customize link & video cards<br>
          ✓ Backup & restore posts<br>
          ✓ Storage usage dashboard<br>
          ✓ AdBlock hashtag included
        </div>
  ...
  // Features grid - only show for non-pro users
  if (!isPro) {
    ...
    features.pro.forEach(f => {
      html += `
        <div style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 12px; text-align: center; opacity: 0.6; background: #f9f9f9;">
          <div style="font-size: 16px; margin-bottom: 4px;">🔒</div>
          <div style="font-weight: 600; font-size: 13px; color: #333;">${f.name}</div>
        </div>
      `;
  ...
  if (!isPro) {
    html += `
      <div style="margin-top: 24px; border-top: 1px solid #e0e0e0; padding-top: 24px;">
        <div style="font-weight: 600; color: #333; margin-bottom: 16px; font-size: 16px;">� Backup & Restore</div>
    ...
    html += `
      <div style="border-top: 1px solid #e0e0e0; padding-top: 24px;">
        ...
        <div style="display: flex; gap: 8px; margin-bottom: 16px;">
          <input type="text" id="license-key-input" placeholder="Paste your license key here..." style="flex: 1; padding: 10px 12px; border: 1px solid #d1d5db; border-radius: 6px; font-size: 14px; font-family: monospace; color: #333; background: white;">
  ...
  if (isPro) {
    html += `
      <div style="margin-top: 24px; border-top: 1px solid #e0e0e0; padding-top: 24px;">
        <div style="font-weight: 600; color: #333; margin-bottom: 16px; font-size: 16px;">⭐ Pro Features</div>
  ...
  // Backup handlers (available to all users)
  ...
  // Pro user only: clear data button
  if (isPro) {
